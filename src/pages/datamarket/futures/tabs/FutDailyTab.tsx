...
export const FutDailyTab: React.FC = () => {
  const { query, setQuery, rows, loading, pagination, total, fetchData } = useFuturesData<FutDaily, FutDailyQuery>({
    fetchFn: async (params) => {
      const res = await getFutDailyList({
        skip: params.skip,
        limit: params.limit,
  ...
  const columns: ColumnsType<FutDaily> = [
