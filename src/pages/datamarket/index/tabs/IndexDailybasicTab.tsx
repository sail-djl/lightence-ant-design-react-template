...
import { IndexDailybasic, getIndexDailybasicList, syncIndexDailybasic, IndexDailybasicSyncPayload, IndexBasic, getIndexBasicList } from '@app/api/datamarket/index.api';
